...
private let hudSize = CGSize(width: 150, height: 110)
private let simpleHUDSize = CGSize(width: 100, height: 100)
private let iconViewSize = CGSize(width: 50, height: 50)
private let iconViewCenter = CGPoint(x: hudSize.width/2, y: 40)
private let simpleHUDIconViewCenter = CGPoint(x: simpleHUDSize.width/2, y: 50)
private let messageLabelMargin = CGFloat(10)
private let messageLabelFrame = CGRect(x: messageLabelMargin,
